...
export function Home(props: HomeProps) {
  ...
  const handleValidTokenEntered = useCallback(
    (accessToken, userName, client) => {
  ...
  const accessTokenFromLocalStorage = localStorage.getItem("githubAccessToken");
  if (
    accessTokenFromLocalStorage != null &&
    accessTokenFromLocalStorage !== accessToken
  ) {
    // Optimistically set the client based on the access token w/o checking.
          ...
          {userName != null && (
            <div className="usa-alert usa-alert--success usa-alert--slim">
              <div className="usa-alert__body">
                ...
                <br />
                Pick from your <Link to={userName}>
